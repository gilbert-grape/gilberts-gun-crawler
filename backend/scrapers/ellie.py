...
Scrapes firearms listings from ellie-firearms.com (PrestaShop-based).
Two-phase approach:
...
CATEGORY_URLS = [
    f"{BASE_URL}/17-kurzwaffen",
    f"{BASE_URL}/18-langwaffen",
    f"{BASE_URL}/19-vollautomatische-waffen",
]


async def scrape_ellie(search_terms: Optional[List[str]] = None) -> ScraperResults:
    """
    Scrape listings from ellie-firearms.com.
